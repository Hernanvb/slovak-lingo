var categories =  [ {basicPhrases: "Basic Phrases"}, {verbs: "Verbs"}, {greetings: "Greetings"}, 
                    {characteristics: "Characteristics"}, {numbers: "Numbers"}, {adjectives: "Adjectives"},
                    {colors: "Colors"}, {periods: "Periods"}, {timeExpressions: "Time Expressions"},
                    {restaurant: "Restaurant"}, {food: "Food"}, {shopping: "Shopping"}, {travel: "Travel"},
...
module.exports = {
                ...
                categoryKeyToName: function (key) {
                    ...
                    categoryIcons:  [
                                      ...
                                      "fas fa-atlas", "fas fa-palette", "fas fa-calendar-alt", "fas fa-clock", "fas fa-utensils",
                                      "fas fa-lemon", "fas fa-shopping-cart", "fas fa-plane-departure", "fas fa-location-arrow",
                                      "fas fa-sun", "fas fa-users", "fas fa-dove", "fas fa-tshirt", "fas fa-language", "fas fa-male",
                                      "fas fa-car-crash", "fas fa-tasks", "fas fa-map"
                                    ],
                        bgColors: [
                                    "bg-primary", 
                                    "bg-warning", 
