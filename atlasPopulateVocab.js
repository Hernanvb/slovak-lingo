...
var categories = {
    ...
    verbs: {
        ...
        "To make": {
            ...
            engSentence: "He makes a decision.",
            svkSentence: "On urobí rozhodnutie."
        },
        "To know": {
            slovak: ["Vedel"],
    ...
    greetings: {
        ...
        "Happy birthday": ["Všetko najlepšie k narodeninám"],
        "Nice to meet you": ["Teší ma", "Rád vás spoznávam"],
    ...
    directions: {
        "Straight": {
            slovak: ["Rovno"],
            engDefinition: "Moving in one direction without turning.",
            svkDefinition: "Pohyb jedným smerom bez otáčania.",
            engSentence: "Go straight ahead.",
            svkSentence: "Choďte rovno."
        },
        "Right (Directions)": {
            slovak: ["Vpravo"],
            engDefinition: "Towards the direction that is on your right side.",
            svkDefinition: "Smerom na pravú stranu.",
            engSentence: "Turn right at the corner.",
            svkSentence: "Na rohu odbočte vpravo."
        },
        "Left (Directions)": {
            slovak: ["Vľavo"],
            engDefinition: "Towards the direction that is on your left side.",
            svkDefinition: "Smerom na ľavú stranu.",
            engSentence: "Turn left at the light.",
            svkSentence: "Na svetle odbočte vľavo."
        },
        "Corner": {
            slovak: ["Roh"],
            engDefinition: "The place where two streets meet.",
            svkDefinition: "Miesto, kde sa stretávajú dve ulice.",
            engSentence: "The shop is on the corner.",
            svkSentence: "Obchod je na rohu."
        },
        "Square": {
            slovak: ["Námestie"],
            engDefinition: "An open area in a town or city.",
            svkDefinition: "Otvorená plocha v meste.",
            engSentence: "The meeting is in the town square.",
            svkSentence: "Stretnutie je na námestí."
        },
        "Crossroads": {
            slovak: ["Križovatka"],
            engDefinition: "A place where two or more roads meet.",
            svkDefinition: "Miesto, kde sa stretávajú dve alebo viac ciest.",
            engSentence: "Turn right at the crossroads.",
            svkSentence: "Na križovatke odbočte vpravo."
        },
        "Entrance": {
            slovak: ["Vchod"],
            engDefinition: "A place where you enter a building or area.",
            svkDefinition: "Miesto, kde vstúpite do budovy alebo oblasti.",
            engSentence: "The entrance is over there.",
            svkSentence: "Vchod je tam."
        },
        "Exit": {
            slovak: ["Východ"],
            engDefinition: "A place where you leave a building or area.",
            svkDefinition: "Miesto, kde opustíte budovu alebo oblasť.",
            engSentence: "Use the exit on your left.",
            svkSentence: "Použite východ naľavo."
        },
        "Road signs": {
            slovak: ["Dopravné značky"],
            engDefinition: "Signs on the road that give information or instructions.",
            svkDefinition: "Značky na ceste, ktoré poskytujú informácie alebo pokyny.",
            engSentence: "Follow the road signs.",
            svkSentence: "Nasledujte dopravné značky."
        },
        "Turn back": {
            slovak: ["Otočte sa"],
            engDefinition: "To go back in the direction you came from.",
            svkDefinition: "Vrátiť sa smerom, odkiaľ ste prišli.",
            engSentence: "You need to turn back.",
            svkSentence: "Musíte sa otočiť."
        },
        "Next to": {
            slovak: ["Vedľa"],
            engDefinition: "At the side of; beside.",
            svkDefinition: "Na strane; vedľa.",
            engSentence: "The bank is next to the post office.",
            svkSentence: "Banka je vedľa pošty."
        },
        "Close to": {
            slovak: ["V blízkosti"],
            engDefinition: "Near in space or time.",
            svkDefinition: "Blízko v priestore alebo čase.",
            engSentence: "The school is close to the park.",
            svkSentence: "Škola je v blízkosti parku."
        },
        "Near": {
            slovak: ["Blízko"],
            engDefinition: "At a short distance away.",
            svkDefinition: "V krátkej vzdialenosti.",
            engSentence: "The store is near here.",
            svkSentence: "Obchod je blízko."
        },
        "On foot": {
            slovak: ["Pešo"],
            engDefinition: "Walking rather than traveling by car or bus.",
            svkDefinition: "Chôdza namiesto cestovania autom alebo autobusom.",
            engSentence: "We are going there on foot.",
            svkSentence: "Ideme tam pešo."
        },
        "Opposite": {
            slovak: ["Oproti"],
            engDefinition: "On the other side of a specific area.",
            svkDefinition: "Na druhej strane určitej oblasti.",
            engSentence: "The pharmacy is opposite the library.",
            svkSentence: "Lekáreň je oproti knižnici."
        },
        "Along": {
            slovak: ["Pozdĺž"],
            engDefinition: "In a line next to something long.",
            svkDefinition: "V rade vedľa niečoho dlhého.",
            engSentence: "Walk along the river.",
            svkSentence: "Choďte pozdĺž rieky."
        },
        "Around": {
            slovak: ["Okolo"],
            engDefinition: "In a circular way or to various places.",
            svkDefinition: "Kruhovým spôsobom alebo na rôzne miesta.",
            engSentence: "Walk around the park.",
            svkSentence: "Choďte okolo parku."
        },
        "Next": {
            slovak: ["Ďalší"],
            engDefinition: "Coming immediately after in time or order.",
            svkDefinition: "Prichádza hneď po čase alebo poradí.",
            engSentence: "Take the next left.",
            svkSentence: "Odbočte na ďalšej ulici vľavo."
        },
        "Crossing": {
            slovak: ["Križovatka"],
            engDefinition: "A place where two roads meet and cross.",
            svkDefinition: "Miesto, kde sa stretávajú a križujú dve cesty.",
            engSentence: "There is a crossing ahead.",
            svkSentence: "Pred vami je križovatka."
        },
        "Ticket": {
            slovak: ["Cestovný lístok"],
            engDefinition: "A piece of paper that gives you the right to travel.",
            svkDefinition: "Kúsok papiera, ktorý vám dáva právo cestovať.",
            engSentence: "Buy a ticket at the station.",
            svkSentence: "Kúpte si cestovný lístok na stanici."
        },
        "Far": {
            slovak: ["Ďaleko"],
            engDefinition: "At a great distance in space or time.",
            svkDefinition: "Vo veľkej vzdialenosti v priestore alebo čase.",
            engSentence: "The beach is far from here.",
            svkSentence: "Pláž je odtiaľto ďaleko."
        },
        "Get off": {
            slovak: ["Vystúpiť"],
            engDefinition: "To leave a vehicle.",
            svkDefinition: "Opustiť vozidlo.",
            engSentence: "Get off the bus at the next stop.",
            svkSentence: "Vystúpte z autobusu na ďalšej zastávke."
        },
    ...
    timeExpressions: {
        "Early": {
            slovak: ["Skoro", "Zavčasu"],
            engDefinition: "Happening or done before the usual or expected time.",
            svkDefinition: "Stáva sa alebo je vykonané pred obvyklým alebo očakávaným časom.",
            engSentence: "She arrived early to the meeting.",
            svkSentence: "Prišla na stretnutie skoro."
        },
        "Late": {
            slovak: ["Neskoro"],
            engDefinition: "Happening or done after the usual or expected time.",
            svkDefinition: "Stáva sa alebo je vykonané po obvyklom alebo očakávanom čase.",
            engSentence: "He was late for the train.",
            svkSentence: "Meškal na vlak."
        },
        "Today": {
            slovak: ["Dnes"],
            engDefinition: "On or in the course of this present day.",
            svkDefinition: "Dnes, v priebehu tohto dňa.",
            engSentence: "I have a meeting today.",
            svkSentence: "Dnes mám stretnutie."
        },
        "Tomorrow": {
            slovak: ["Zajtra"],
            engDefinition: "On the day after today.",
            svkDefinition: "Na deň po dnešku.",
            engSentence: "We will go to the park tomorrow.",
            svkSentence: "Zajtra pôjdeme do parku."
        },
        "Yesterday": {
            slovak: ["Včera"],
            engDefinition: "On the day before today.",
            svkDefinition: "Na deň pred dneškom.",
            engSentence: "I saw her yesterday.",
            svkSentence: "Videla som ju včera."
        },
        "Now": {
            slovak: ["Teraz"],
            engDefinition: "At the present moment.",
            svkDefinition: "V súčasnom okamihu.",
            engSentence: "I am busy now.",
            svkSentence: "Teraz som zaneprázdnený."
        },
